...
class Tray_CheckoutApi_Model_Pix extends Tray_CheckoutApi_Model_Standard
{
    ...
    protected $_code  = 'traycheckoutapi_pix';
    
    protected $_formBlockType = 'checkoutapi/form_pix';
    
    protected $_blockType = 'checkoutapi/pix';
    
    protected $_infoBlockType = 'checkoutapi/info_pix';
